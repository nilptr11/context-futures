...
DEFAULT_BROOKS_BUCKET_DIMENSIONS: tuple[tuple[str, ...], ...] = (
    ...
    ("setup_family", "pattern_variant"),
    ("setup_family", "market_cycle"),
    ("pattern_variant", "market_cycle"),
...
DEFAULT_BROOKS_DECISION_DIMENSIONS: tuple[tuple[str, ...], ...] = (
    ...
    ("setup_family", "pattern_variant"),
    ("setup_family", "market_cycle"),
    ("pattern_variant", "decision_reason"),
    ...
    with output_path.open("w", newline="") as handle:
        ...
        for record in records:
            row = {
                ...
                "pattern_variant": record.pattern_variant,
                "side": record.side,
